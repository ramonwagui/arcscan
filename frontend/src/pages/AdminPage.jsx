                        ...
                        <div className="p-10 space-y-8">
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-2 border-b border-slate-100">
                                ...
                                <form
                                    ...
                                    className="flex gap-2 p-2 bg-slate-50 border border-slate-100 rounded-2xl"
                                >
                                    <input
                                        name="email"
                                        type="email"
                                    ...
                                    />
                                    <button type="submit" className="h-10 px-6 rounded-xl bg-primary-500 text-white text-[10px] font-black uppercase tracking-widest flex items-center gap-2 hover:scale-[1.02] active:scale-95 transition-all">
                                                ...
                                                <tr key={u.id} className="group hover:bg-slate-50 transition-all">
                                                    <td className="py-5 px-8">
                                                        <div className="flex items-center gap-3">
                                                            ...
                                                            <div className="flex flex-col">
                                                                <span className="text-sm font-black text-slate-800 tracking-tight">{u.email}</span>
                                                    ...
                                                    <td className="py-5 px-8">
                                                        <select
                                                            ...
                                                            className="bg-transparent border-none focus:ring-0 text-[10px] font-black uppercase tracking-widest text-slate-600 p-0 cursor-pointer disabled:opacity-40"
                                                        >
